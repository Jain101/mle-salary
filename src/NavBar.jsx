...
function NavBar() {
    return (
        <>
            {/* <div className="flex justify-center fixed w-full top-0 z-50 p-10"> */}
            <div className="fixed top-0 left-0 right-0 bg-base-200 z-50 flex justify-center items-center px-4 py-2">
                <ul className="flex flex-row justify-center align-middle text-center gap-6 menu bg-base-200 lg:menu-horizontal rounded-box">
                    <li>
                        <Link to={'/dashboard'}>

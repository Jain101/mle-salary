...
function NavBar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-base-200 shadow-md flex justify-center items-center px-4 py-2">
            <ul className="flex flex-row justify-center gap-6 text-center menu rounded-box">
                <li className={`${activeLink === 'Home' ? 'bg-base-300 text-black rounded-sm' : ''}`}>
                ...
                <li className={`${activeLink === 'Dashboard' ? 'bg-base-300 text-black rounded-sm' : ''}`}>
                ...
                <li className={`${activeLink === 'AI Assistant' ? 'bg-base-300 text-black rounded-sm' : ''}`}>
                    <Link to={'/chatbot'} onClick={() => handleClick('AI Assistant')}>
